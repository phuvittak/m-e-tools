        ...
        '<div class="me-footer-brand"><div class="me-footer-wm">M.E.<span style="color:var(--price-red)">T</span>ools</div>' +
          ...
          '<div class="me-footer-rows">' +
            ...
            String(st.phone || "").split(/[,\n]/).map(function (p) { return p.trim(); }).filter(Boolean).map(function (p) {
              ...
              var label = digits.slice(0, 3) === "053" ? "สำนักงาน" : (digits.length >= 9 && digits.charAt(0) === "0" && "689".indexOf(digits.charAt(1)) >= 0 ? "มือถือ" : "");
              return '<div class="me-footer-row"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>' + (label ? '<span class="me-phone-lbl">' + label + '</span>' : '') + '<a href="tel:' + esc(digits) + '">' + esc(p) + "</a></div>";
            }).join("") +
            (function () { var lineId = st.line || ""; if (!lineId) return ""; var lineHref = /^https?:\/\//.test(lineId) ? lineId : (lineId.charAt(0) === "@" ? "https://line.me/ti/p/" + lineId : "https://line.me/ti/p/@" + lineId); return '<div class="me-footer-row"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg><a href="' + esc(lineHref) + '" target="_blank" rel="noopener">LINE: ' + esc(lineId) + "</a></div>"; })() +
          "</div>" +
