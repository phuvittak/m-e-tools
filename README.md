...
1) เปิด https://manager.line.biz/ → OA `M.E.Tools ท่ารั้ว`
2) เมนูซ้าย **ริชเมนู** (หรือ Rich Menu)
3) คลิก **+ สร้างใหม่**
4) เลือก template (6 ช่อง 2×3 แนะนำ)
5) อัปโหลดรูปพื้นหลัง (ขนาด 2500×1686 px แนะนำสีดำพร้อมโลโก้ DEWALT เหลือง)
6) ตั้งแต่ละช่อง:
   - ช่อง 1: 🛠️ ดูเครื่องมือ → ส่งข้อความ `ดูสินค้า`
   - ช่อง 2: 📦 เช่ารายวัน → ส่งข้อความ `เช่า`
   - ช่อง 3: 💰 โปรโมชั่น → ส่งข้อความ `โปร`
   - ช่อง 4: 📍 ที่อยู่ร้าน → ส่งข้อความ `ที่อยู่`
   - ช่อง 5: 📞 ติดต่อ → ส่งข้อความ `ติดต่อ`
   - ช่อง 6: 👤 ติดต่อเจ้าของ → ส่งข้อความ `ติดต่อเจ้าของ`
7) เปิดใช้งาน + **ตั้งให้แสดงเป็นค่าตั้งต้น**
